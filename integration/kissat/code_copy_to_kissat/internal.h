...
#include "imitsat_client.h"   // forward decl only in header; full use here
...
#ifndef KISSAT_IMITSAT_DYN_CAP
#define KISSAT_IMITSAT_DYN_CAP 8192
#endif

  statistics statistics;
    // --- ImitSAT guidance (optional) ---
  imitsat_options imopts;   // parsed in main.c (enabled/port/limit/timeout)
  imitsat_client  imc;      // TCP connection & counters

  /* rolling dynamic tail, always ends with a single trailing ' D' */
  char            imitsat_dyn[KISSAT_IMITSAT_DYN_CAP];  // "D <lit> D <lit> ..."
  size_t          imitsat_dyn_sz;    // bytes used in imitsat_dyn
  /* ---- end ImitSAT integration ---- */
};
